...
public class UserController {
	   ...
	   @RequestMapping("/User")
		...
		public String FindTrains(@RequestParam("trainFrom")String trainFrom,@RequestParam("trainTo")String trainTo,@RequestParam("departureDate") @DateTimeFormat(pattern = "MM-dd-yyyy") String departureDate, Model model) {
		...
		return "/UserLogin/displayTrains";
		 ...
		 public String ShowPaymentDetails(@ModelAttribute Passenger passenger ,@RequestParam("id")long id, Principal principal,Model model) {				  
...
//				}
		     ...
		     public String MyBooking(Model model,@ModelAttribute Passenger passenger ,Principal principal) {
			  ...
			  List<UserBookingDTO> userBookingList = new ArrayList<>();
			   ...
			   public String CancelTrain(@RequestParam("id") long id,@RequestParam("myBookingId") long myBookingId,Model model,Principal principal) {
